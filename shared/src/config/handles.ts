...
/** Noun half, drawn from the game's own things: balloons, sky, stairs. */
const SECOND = [
  'Balloon', 'Floater', 'Cloud', 'Star', 'Blimp', 'Popper', 'Breeze', 'Kite',
  'Comet', 'Climber', 'Rocket', 'Zeppelin', 'Feather', 'Stairs', 'Skipper', 'Spark',
] as const;
...
/** How many places each board shows. Matches the reference art's eight rows. */
