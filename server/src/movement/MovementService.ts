 ...
 * becomes the player's transform. The reach a jump rises toward comes from the
 * player's replicated balloons, which only the server writes.
 */
export class MovementService {
  ...
  private publish(player: PlayerState, sim: Sim): void {
    ...
    player.airGravity = m.airGravity;
    player.airTerminal = m.airTerminal;
