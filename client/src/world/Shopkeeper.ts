...
import { SHOP_KEEPER } from './BalloonShop.js';
...
/**
 * Mia, the shopkeeper behind the Balloon Shop counter.
 *
...
export class Shopkeeper {
  ...
  constructor() {
    ...
    this.root.position.set(SHOP_KEEPER.x, SHOP_KEEPER.platformHeight, SHOP_KEEPER.z);
