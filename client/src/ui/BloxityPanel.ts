...
const BUX_PRODUCTS: readonly { sku: string; name: string; blurb: string }[] = [
  { sku: 'wins_small', name: 'Pouch of Wins', blurb: 'A head start on better balloons and eggs.' },
  { sku: 'wins_large', name: 'Chest of Wins', blurb: 'Enough for a serious balloon upgrade.' },
];
